...
f.  Double click on the chart title and change it to **Labour Force Participation Rate**.

g.  Double click on the x-axis and change *Title* from **Year of Year** to **Year**.

h.  Double click on the y-axis and remove the *Title*. Set *Range* to **Fixed start = 0**, **Fixed end = 100**.

i.  Right click the y-axis and select **Format**. On the left pane, go to Scale \> Numbersand select **Number(Custom)**. Set *decimal places* to **0** and *suffix* to **%**.
...
g.  From the *Show Me* pane on the right, select **Area chart (continuous)**.
    ...
    ![](images/07.3%20select%20area%20chart%20continuous.png){width="250"}

h.  Double click on the chart title and change it to **Distribution of labour force**.

i.  Double click on the x-axis and change *Title* to **Year**.
...
### D.3 Creating the dashboard (static) on Tableau
