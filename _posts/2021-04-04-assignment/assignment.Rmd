...
-   *formattable()* from **formattable** package
...
-   *reactable()* from **reactable** package
...
-   line plot
    ...
    In the line chart below where each skill group category is a series, the lines overlap and hence several data points are hidden. 
