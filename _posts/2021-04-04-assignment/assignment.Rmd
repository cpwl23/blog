...
In the line chart below where each skill group category is a series, the lines overlap and hence several data points are hidden. We decide not to introduce facets for the same reasons discussed previously.
